...
START_MESSAGE = (
        ...
        'If you want to host your own bot then here is the github repo under the terms of the [GNU General Public License v3.0](https://github.com/meanii/sessionMaker/blob/main/LICENSE).\n'
